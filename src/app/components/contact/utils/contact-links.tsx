...
const links: LinkData[] = [
    ...
    { Icon: SiLinkedin, href: "#", label: "LinkedIn", color: "hover:bg-blue-700" },
    { Icon: SiGithub, href: "#", label: "Github", color: "hover:bg-zinc-600" },
    { Icon: SiInstagram, href: "#", label: "Instagram", color: "hover:bg-pink-700" },
    { Icon: SiFacebook, href: "#", label: "Facebook", color: "hover:bg-blue-600" },
    { Icon: SiX, href: "#", label: "X", color: "hover:bg-gray-800" },
    { Icon: SiSlack, href: "#", label: "Slack", color: "hover:bg-yellow-600" },
...
const LinkBox = ({ Icon, href, label, color }: LinkData) => {
    ...
    return (
        <motion.a
            ...
            whileHover={{ scale: 1.02, translateY: -100, borderRadius: 40 }}
            transition={{
                duration: 0.1,
                ease: easeIn,
                type: "spring",
